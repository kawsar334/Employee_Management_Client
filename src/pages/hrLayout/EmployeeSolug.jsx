...
//             try {
//                 const response = await axios.get(`http://localhost:7000/api/payment/getEmployeeDetails/${slug}`,{
...
//                     'rgba(255, 159, 64, 0.5)'
//                 ], // Alternating colors for better visualization
//                 borderColor: [
//                     'rgba(75, 192, 192, 1)',
//                     'rgba(255, 99, 132, 1)',
//                     'rgba(54, 162, 235, 1)',
...
//                     'rgba(153, 102, 255, 1)',
//                     'rgba(255, 159, 64, 1)'
//                 ], // Border colors matching the background
//                 borderWidth: 2, // Slightly thicker borders for better clarity
//                 borderRadius: 10, // Rounding the edges of the bars
//                 hoverBackgroundColor: 'rgba(255, 159, 64, 0.7)', // Color on hover
//                 hoverBorderColor: 'rgba(255, 159, 64, 1)', // Border color on hover
