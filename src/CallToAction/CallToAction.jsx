...
const CallToAction = () => {
    return (
        <section className="py-16 bg-main opacity-100 text-white text-center">
            <div className="container mx-auto px-6">
                ...
                <NavLink
                    href="/register"
                    className="bg-text text-main hover:bg-indigo-100 py-3 px-6 rounded-full font-semibold transition duration-300"
                >
                    Sign Up Today
                </NavLink>
